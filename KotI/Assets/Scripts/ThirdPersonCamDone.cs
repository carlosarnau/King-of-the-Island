...
public class ThirdPersonCamDone : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        playerObj = GameObject.Find("Client Player").GetComponent<Transform>();
    }
    ...
    public void Update()
    {
        ...
        playerObj.transform.eulerAngles = new Vector3(playerObj.transform.eulerAngles.x, orientation.transform.eulerAngles.y, playerObj.transform.eulerAngles.z);
    }
